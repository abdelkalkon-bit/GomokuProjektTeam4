...
# TC-18 – Bevara matchens state
## Relaterat UC:
UC-09 / UC-12
## Förutsättningar:
En match är igång och flera drag har gjorts.
# Steg:
1. Starta en match.
2. Gör flera drag.
3. Pausa eller lämna matchen enligt systemets funktion.
4. Återuppta matchen.
# Förväntat resultat:
* De tidigare placerade stenarna finns kvar.
* Rätt spelare har tur.
* Matchen fortsätter från samma state.

# TC-19 – Internetavbrott
## Relaterat UC:
UC-11
## Förutsättningar:
En online-match är igång.
# Steg:
1. Starta en online-match.
2. Gör några drag.
3. Stäng av internet en kort stund.
4. Anslut till internet igen.
# Förväntat resultat:
* Matchen försvinner inte vid ett tillfälligt internetavbrott.
* Den senaste spelstatusen finns kvar.
* Rätt spelare har tur efter återanslutningen.

# TC-20 – Samma state hos båda online-spelarna
## Relaterat UC:
UC-12
## Förutsättningar:
Två spelare är anslutna till samma online-match.
# Steg:
1. Starta en online-match.
2. Spelare 1 gör ett drag.
3. Kontrollera spelare 2:s spelplan.
4. Gör samma kontroll efter flera drag.
# Förväntat resultat:
* Båda spelarna ser samma stenar.
* Båda spelarna har samma aktuella spelstatus.
* Turordningen är samma för båda spelarna.
...
# Steg:
1. Starta en match.
2. Placera flera stenar på olika platser.
3. Kontrollera spelplanens storlek och placering.
# Förväntat resultat:
* Spelplanen ändrar inte storlek.
...
# Steg:
1. Skapa en online-match.
2. Kontrollera spellänken som skapas.
# Förväntat resultat:
* Spellänken innehåller ingen personlig information om spelaren.
* Det behövs inga personuppgifter för att spela.
